...
const { mergedTypeDefs, mergedResolvers } = require('./schemas'); // Imports the type definitions and resolvers for our GraphQL API.
...
startApolloServer(mergedTypeDefs, mergedResolvers); // Passed the merged typeDefs and resolvers. 